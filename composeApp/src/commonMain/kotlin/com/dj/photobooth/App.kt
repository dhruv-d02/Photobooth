 ...
 * Preview and Strip Detail destinations reached from Capture and the Gallery grid respectively
 * (architecture.md § Screen navigation). Screen-level composables (CaptureScreen,
 * LandingScreen, ...) are no longer hosted directly here; that responsibility now lives
 * entirely in the NavHost.
 *
